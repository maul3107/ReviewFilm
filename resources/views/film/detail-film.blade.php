...
@section('content')
        ...
        <div class="container m-auto mt-16 px-3 md:px-0">
                        ...
                        <div class="comment-scroll flex-1 overflow-y-auto mt-4 space-y-4 pr-2">
                            ...
                            @else
                                ...
                                <div class="flex flex-col items-center justify-center py-10 text-center">
                                    ...
                                    <p class="text-gray-400 text-lg">Tidak ada komentar</p>
                                    <p class="text-gray-500 text-sm mt-2">Jadilah yang pertama memberikan ulasan</p>
                                </div>
                            @endif
                        </div>
            ...
            <div class="mt-5">
                @if ($commentsNew->count() > 0)
                    ...
                    @endforeach
                @else
                    <!-- Empty state message for main comments section -->
                    <div
                        class="flex flex-col items-center justify-center py-10 text-center bg-gray-800 bg-opacity-20 rounded-lg">
                        <div class="text-gray-500 text-5xl mb-3">
                            <i class="fa-regular fa-comment-dots"></i>
                        </div>
                        <p class="text-gray-400 text-lg">Tidak ada komentar</p>
    ...
    <div class="container m-auto px-3 md:px-0 mb-16">
                ...
                <div class="swiper-wrapper">
                    @foreach ($randomFilms as $randomFilm)
                        <div class="swiper-slide w-full">
                            <a href="{{ route('detail-film', $randomFilm->slug) }}" class="film-card block">
