...
@section('content')
    ...
    <div class="mt-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div class="p-4 shadow-sm rounded-md bg-gray-200 flex items-center">
            ...
            <div class="p-4 shadow-sm rounded-md bg-gray-200 flex items-center">
                ...
                <div class="ml-5">
                    ...
                    <div class="text-gray-500">Total Genre Relation</div>
                </div>
            </div>
            ...
            <div class="p-4 shadow-sm rounded-md bg-gray-200 flex items-center">
                ...
                <div class="ml-5">
                    <h4 class="text-2xl font-semibold text-gray-700">{{ $totalCastings }}</h4>
                    <div class="text-gray-500">Total Casting</div>
                </div>
            </div>
        </div>
    </div>
