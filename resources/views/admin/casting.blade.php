...
<div class="relative overflow-x-auto sm:rounded-lg">
    <div class="flex flex-col sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
        <div>
            <a href="{{ route('admin.create-casting') }}" class="inline-flex items-center text-white font-medium rounded-lg text-sm px-3 py-2 bg-blue-600">
                Tambah Data
            </a>
        </div>
        <div class="relative">
        ...
        <tbody>
            ...
            <tr class="bg-white border border-gray-300">
                ...
                <td class="px-6 py-4 flex space-x-3">
                    ...
                    <form action="{{ route('admin.delete-casting', $casting->id) }}" method="POST" class="inline delete-form" data-title="{{ $casting->id }}">
                        @csrf
                        @method('DELETE')
