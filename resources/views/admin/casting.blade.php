            ...
            <div class="relative">
                <form method="GET" action="{{ route('admin.casting.index') }}">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}"
                        placeholder="Cari Berdasarkan Nama Panggung"
                ...
                @foreach ($castings as $casting)
                    <tr class="bg-white border border-gray-300">
                        ...
                        <td class="border border-gray-300 px-6 py-4">
                            <img src="{{ $casting->photo ? asset('storage/' . $casting->photo) : asset('images/default-avatar.png') }}"
                        ...
                        <td class="border border-gray-300 px-6 py-4">{{ $casting->film->title }}</td>
                        <td class="px-6 py-4 flex space-x-3">
                            <a href="{{ route('admin.edit-casting', $casting->id) }}"
                            ...
                            <form action="{{ route('admin.delete-casting', $casting->id) }}" method="POST"
                                class="inline delete-form" data-title="{{ $casting->id }}">
                                @csrf
                                @method('DELETE')
