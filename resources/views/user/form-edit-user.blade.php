...
@section('content')
    ...
    <form action="{{ route('admin.update-user', $user->id) }}" method="POST"
        class="form-input-data w-full container m-auto mt-5 p-10 rounded-lg bg-gray-50 shadow-md"
        enctype="multipart/form-data">
        @csrf
        @method('PUT')

        <h1 class="text-3xl text-gray-900 font-bold mb-5">Form Edit User</h1>
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full px-3">
                ...
                <input
                    ...
                    id="name" type="text" name="name" placeholder="Enter username"
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full px-3">
                ...
                <input
                    ...
                    id="email" type="email" name="email" placeholder="Enter email"
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full px-3">
                <label class="block uppercase tracking-wide text-gray-900 text-xs font-bold mb-2" for="avatar">
                    Profile Picture
                </label>
                ...
                @if ($user->avatar)
                    <div class="mb-3">
                        <img src="{{ asset('storage/' . $user->avatar) }}" alt="User Avatar"
                            class="w-32 h-32 object-cover rounded border border-gray-300 shadow-sm">
                    </div>
                @endif

                <input
                    class="appearance-none block w-full bg-white text-gray-700 border {{ $errors->has('avatar') ? 'border-red-500' : 'border-gray-300' }} rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
